...
class HealthServiceTest {
    ...
    void reportsUpWhenSourceDataAndDatabaseAreUsable() throws Exception {
        ...
        Path data = tempDir.resolve("lens-data");
        ...
        assertThat(health.checks()).containsEntry("codexSource", "OK");
    ...
    void reportsDownWhenCodexSourceIsMissing() {
        ...
        assertThat(health.checks()).containsEntry("codexSource", "directory missing");
    }
}
